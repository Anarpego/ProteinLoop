.PHONY: test demo serve web-deps web-assets web-test web-serve submission-render submission-check submission-ready-check docker-smoke ci-check live-demo-check
