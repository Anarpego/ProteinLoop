...
OPERATOR_NEEDLES = [
    ...
    "Self-hosted Gemma + local verifier",
    "Solar + battery edge power",
    "Producer approval",
    "Producer view",
    "Captured AMD experiment",
    "google/gemma-4-E2B-it",
    "Gemma explored 6 recovery plans on AMD",
    "Five-emergency product audit",
    "30 AMD Gemma plans tested",
    "20-emergency verifier-feedback audit",
    "18 rejected answers repaired",
    "100% safe after feedback",
    "Public app remains on CPU fallback",
    "Run demo cascade",
    ...
    "Live agent activity",
    "5-agent team standing by",
    "AI activity is visible as structured events",
...
PRODUCER_NEEDLES = [
    ...
    "Latest DECT NR+ link",
    "DECT NR+ is the private, non-cellular 5G field link",
    "Sequence #100",
    "real radio",
    "Live tank simulation",
    "Open tank full screen",
