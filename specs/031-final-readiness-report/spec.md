...
4. The command evidence shall capture exit codes for local tests, CI workflow contract validation, public deploy profile validation, Gemma endpoint validation, final submission readiness, and GitHub CLI authentication.
