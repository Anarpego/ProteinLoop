# Tasks: Immersive Agentic Tank

- [x] Define the full-screen and Agentic AI interaction contract.
- [x] Add failing component, LiveView, and hook tests.
- [x] Add the reusable full-screen control.
- [x] Implement Fullscreen API lifecycle handling.
- [x] Add responsive immersive layout styles.
- [x] Add the operator-only mission console using existing events.
