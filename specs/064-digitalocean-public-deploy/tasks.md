# Tasks: DigitalOcean Public Deployment

- [x] Audit existing deployment patterns, server capacity, containers, and Caddy.
- [x] Add failing public-bind and deploy-script tests.
