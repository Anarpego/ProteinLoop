# Tasks: AMD Experiment Replay

- [x] Define the replay, provenance, safety, and fallback contract.
- [x] Add failing evidence-loader tests.
- [x] Implement strict paired-artifact validation.
