...
Two physical nRF9151 boards prove a bidirectional DECT NR+ field link without Wi-Fi, a SIM, or cloud access; Gemma runs on separate compute. On the assigned Act-II AMD notebook, Gemma 4 E2B ran through vLLM on ROCm with 47.98 GiB GPU memory. Six-plan search moved ammonia from 2.4 to 0.7228 mg/L, oxygen from 4.8 to 5.6742 mg/L, and reward +71.092 over naive operation. In a 20-emergency audit, only 2 first answers were safe. Exact verifier feedback repaired the other 18, yielding 20/20 model-safe plans with zero fallback. The run observed 139 requests, 60,385 tokens, and 420.648 kg of aggregate scenario biomass. This was inference-time repair, not training. The public demo remains a durable private CPU deployment and labels AMD results as captured evidence. Physical chemistry probes and measured solar autonomy remain next proofs.
