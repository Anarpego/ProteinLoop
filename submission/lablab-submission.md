...
3. Press `Simulate node loss` to show agent migration. The repo also includes `submission/mesh-evidence.md` proving state-token preservation from the Elixir mesh model and `submission/nrf9151-field-plan.md` mapping the two DECT NR+ boards to the field story.
